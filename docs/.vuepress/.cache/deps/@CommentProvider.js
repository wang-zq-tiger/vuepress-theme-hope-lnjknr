...
import "E:/my_vuepress/vuepress-theme-hope-lnjknr/node_modules/@waline/client/dist/waline.css";
import "E:/my_vuepress/vuepress-theme-hope-lnjknr/node_modules/vuepress-plugin-comment2/lib/client/styles/waline.scss";
var e = COMMENT_OPTIONS;
var k = WALINE_LOCALES;
var i = Boolean(e.serverURL);
WALINE_META && import("E:/my_vuepress/vuepress-theme-hope-lnjknr/node_modules/@waline/client/dist/waline-meta.css");
var A = defineComponent({ name: "WalineComment", setup() {
  const a = useRoute(), l = (0, client_exports.usePageFrontmatter)(), p = (0, client_exports.usePageLang)(), s = tt(k);
  let t;
  const c = computed(() => {
    if (!i)
      return false;
